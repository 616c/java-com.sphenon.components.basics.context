...
public class DumpNode_Writer implements DumpNode {
    ...
    protected DumpNode_Writer parent;
    ...
    public DumpNode_Writer (CallContext context, PrintWriter out, String indent, DumpNode_Writer parent, boolean show_names, boolean name_value_same_line, String indent_increment, boolean technical_details) {
        this.out    = out;
        this.first  = true;
    ...
    public void dump(CallContext context, String name, Object value) {
        ...
        if (value instanceof Dumpable) {
            if (this.isCurrentlyDumped(context, value)) {
                ...
                DumpNode subdn = new DumpNode_Writer(context, this.out, new_indent, this, this.show_names, this.name_value_same_line, this.indent_increment, this.technical_details);
    ...
    public DumpNode openDump(CallContext context, String name, boolean is_technical_detail) {
        ...
        return new DumpNode_Writer(context, this.out, new_indent, this, this.show_names, this.name_value_same_line, this.indent_increment, this.technical_details);
    }
